...
pascal_voc_to_keras_image_converter = PascalVocToKerasImageConverter()
pascal_voc_to_keras_image_converter.convert(pascal_voc_dataset_path, keras_image_dataset_path)
