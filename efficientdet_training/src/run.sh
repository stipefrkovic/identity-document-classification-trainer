...
python /app/src/scripts/model_main_tf2.py --model_dir /app/src/models/my_efficientdet_d0_coco17_tpu-32 --pipeline_config_path /app/src/models/my_efficientdet_d0_coco17_tpu-32/pipeline.config --num_train_steps 200 --checkpoint_every_n 100
